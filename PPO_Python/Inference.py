            ...
            while True:
                ...
                if step % LOG_EVERY == 0 or action_changed and step <= 10:
                    log.write(
                        ...
                        f"health_p={info.get('health_proportional', 0.0):.5f} "
                        f"health_i={info.get('health_integral', 0.0):.5f} "
                        f"health_d={info.get('health_derivative', 0.0):.5f} "
                        f"death={info.get('death', 0.0):.1f} "
                        f"survival={info.get('survival', 0.0):.5f} "
